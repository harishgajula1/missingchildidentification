...
class Ui_AuthorityRegister(object):
    ...
    def registering(self):
        ...
        try:
            ...
            if name == "" or name == "null" or unm == "" or unm == "null" or pwd == "" or pwd == "null" or email == "" or email == "null" or mno == "" or mno == "null":
                ...
                sql = "select count(*) from authority where uid='" + unm + "'"
                cursor.execute(sql)
                res = cursor.fetchone()[0]
                if res > 0:
                    self.showMessageBox("Information", "User ID already exists..!")
                else:
    ...
    def setupUi(self, Dialog):
        ...
        Dialog.setStyleSheet("background-color: rgb(130, 191, 200);")
...
"font: 75 16pt \"Verdana\";")
        ...
        self.label_2.setGeometry(QtCore.QRect(100, 94, 111, 61))
...
"font: 75 14pt \"Times New Roman\";")
        ...
        self.label_7.setGeometry(QtCore.QRect(410, 100, 261, 431))
        self.label_7.setStyleSheet("image: url(../MissingChild/images/registericon.png);")
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Authority Registration"))
        self.label.setText(_translate("Dialog", "         Register Here"))
        self.label_2.setText(_translate("Dialog", "Officer Name"))
