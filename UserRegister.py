...
class Ui_UserReg(object):
    ...
    def registering(self):
        ...
        try:
            ...
            if name == "" or name == "null" or unm == "" or unm == "null" or pwd == "" or pwd == "null" or email == "" or email == "null" or mno == "" or mno == "null":
                ...
                sql = "select count(*) from users where uid='" + unm + "'"
                cursor.execute(sql)
    ...
    def setupUi(self, Dialog):
        ...
        Dialog.setStyleSheet("background-color: rgb(255, 211, 217);")
...
"font: 75 14pt \"Times New Roman\";")
        ...
        self.label_7.setStyleSheet("image: url(../MissingChild/images/regicon.png);")
