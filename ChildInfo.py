        ...
        try:
            ...
            for row in res:
                ...
                self.camera_2.setStyleSheet(
                    "image: url(../MissingChild/photos/" + str(self.found) + "/" + str(photo) + ");")
...
"color: rgb(255, 255, 255);")
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Child Info"))
