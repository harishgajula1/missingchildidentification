...
from UserRegister import Ui_UserReg
    ...
    def logincheck(self, event):
            ...
            try:
                ...
                if unm == "" or unm == "null" or pwd == "" or pwd == "null":
                    ...
                    sql = "select count(*) from users where uid='" + unm + "' and pwd='" + pwd + "'"
                    cursor.execute(sql)
                    res = cursor.fetchone()[0]
                    if res > 0:
                        self.home = QtWidgets.QDialog()
                        self.ui = Ui_UserHome(self.home,unm)
...
"color: rgb(0, 0, 0);")
        ...
        self.label_4.setGeometry(QtCore.QRect(430, 120, 211, 251))
        self.label_4.setStyleSheet("image: url(../MissingChild/images/userss.png);")
        self.label_4.setText("")
        self.label_4.setObjectName("label_4")
        self.register_2 = QtWidgets.QLabel(Dialog)
        self.register_2.setGeometry(QtCore.QRect(470, 340, 121, 41))
        self.register_2.setStyleSheet("image: url(../MissingChild/images/register-button.png);")
